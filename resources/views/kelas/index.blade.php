        ...
        <div class="container">
            <div class="card shadow">
                <div class="card-header d-flex justify-content-between align-items-center">
                    ...
                    <a href="{{ action([App\Http\Controllers\KelasController::class, 'create']) }}" class="btn btn-primary">
                        Create
                    </a>
                </div>
                        ...
                        <table class="table table-striped table-hover align-middle">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <form action="{{ action([App\Http\Controllers\KelasController::class, 'destroy'], $k->id) }}" method="post" class="d-inline">
                                            @csrf
                                            @method('DELETE')
